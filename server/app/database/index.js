// DATABASE SETUP
let mongoURL = process.env.OPENSHIFT_MONGODB_DB_URL || process.env.MONGO_URL || 'mongodb://localhost:27017/yastaria'; // set mongo url PC_CURSO: mongodb://172.27.96.198:27017/yastaria
let mongoURLLabel = "";
